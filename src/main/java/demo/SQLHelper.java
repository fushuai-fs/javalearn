...
//    public static String driver = "com.microsoft.jdbc.sqlserver.SQLServerDriver";
     ...
     * 连接字符串
     */
//    public static String url = "jdbc:microsoft:sqlserver://localhost:1433;DatabaseName=Hotel";
    public static String url = "jdbc:sqlserver://localhost:1433;DatabaseName=Hotel";
    /**
     * 用户名
     */
     ...
     * 密码
     */
    public static String password = "fushuai";
    /**
     * 不允许实例化该类
     */
    private SQLHelper()
